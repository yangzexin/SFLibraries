//
//  SFMemoryObjectMappingCollector.m
//  SFiOSKit
//
...
@interface SFMappingStringCollector () <SFObjectMappingCollectorDelegate>
...
@implementation SFMappingStringCollector
...
{
    SFMappingStringCollector *collector = [self new];
    if (mapping) {
